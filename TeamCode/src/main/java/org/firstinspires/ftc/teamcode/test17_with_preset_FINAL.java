...
@Configurable
@TeleOp(name = "test17_with_preset_STABLE_FINAL")
public class test17_with_preset_FINAL extends OpMode {
    ...
    public void loop() {
        ...
        if (triggerActive) {
            // GP1 triggers override toggle
            intake.setPower(intakePower);
        } else {
            // GP2 toggle works only when triggers are NOT used
