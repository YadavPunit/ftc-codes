...
@Autonomous(name = "blue_apex_mix_align_with_turret_move", group = "Auto")
public class blue_apex_mix_align_with_turret_move extends LinearOpMode {
    ...
    static final double TURRET_kD = 0.0042;
    ...
    static final double TURRET_LL_OFFSET_DEG = 2;
    ...
    public void runOpMode() {
        ...
        moveTurretDegrees(0);   // example manual turret move
