...
@Configurable
@TeleOp(name = "test26")
public class test26 extends OpMode {
    ...
    // ===== Turret constants =====
    // ===== TURRET PIDF : NEAR =====
    public static double TURRET_NEAR_kP = 0.95;
    public static double TURRET_NEAR_kD = 0.08;
    public static double TURRET_NEAR_kF = 0.045;

    // ===== TURRET PIDF : FAR =====
    public static double TURRET_FAR_kP = 0.55;
    public static double TURRET_FAR_kD = 0.16;
    public static double TURRET_FAR_kF = 0.06;

    // ===== SWITCH THRESHOLD =====
// Use TX or TY — TX is more reliable for distance
    public static double FAR_TX_THRESHOLD = 10.5;
    private boolean isFarTarget(LLResult ll) {
        return Math.abs(ll.getTx()) > FAR_TX_THRESHOLD;
    }
    ...
    private void alignTurret(boolean enable) {
        ...
        // ===== AUTO ALIGN (DUAL PIDF) =====
        if (enable && hasTarget) {

            double error = ll.getTy() - TURRET_TY_OFFSET;

            // ---- SELECT PIDF SET ----
            boolean far = isFarTarget(ll);

            double kP = far ? TURRET_FAR_kP : TURRET_NEAR_kP;
            double kD = far ? TURRET_FAR_kD : TURRET_NEAR_kD;
            double kF = far ? TURRET_FAR_kF : TURRET_NEAR_kF;
            ...
            telemetryM.addData("Turret Mode", far ? "FAR" : "NEAR");
        }
