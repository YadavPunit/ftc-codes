...
@Configurable
@TeleOp(name = "test_gamepad1")
public class test_gamepad1 extends OpMode {
    ...
    public void loop() {
        ...
        if (!gamepad1.left_bumper) {
            ...
            if (gamepad1.dpad_left) manualPower = -TURRET_MANUAL_POWER;
            else if (gamepad1.dpad_right) manualPower = TURRET_MANUAL_POWER;
        ...
        // ===== LIFT =====
        if (gamepad2.dpad_up) setLift(true);
        else if (gamepad2.dpad_down) setLift(false);
        ...
        if (rpm < RAMP_MIN_RPM) {
            ...
            if (gamepad1.dpad_up) setRamp(true);
            else if (gamepad1.dpad_down) setRamp(false);
        }
    }
