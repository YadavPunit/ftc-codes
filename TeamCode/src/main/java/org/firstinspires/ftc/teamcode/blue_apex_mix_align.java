...
@Autonomous(name = "blue_apex_mix_align", group = "Auto")
public class blue_apex_mix_align extends LinearOpMode {
    ...
    // ================= TURRET (FROM TELEOP) =================
    static final double TURRET_kP = 0.049;
    static final double TURRET_kD = 0.005;
    static final double TURRET_DEADBAND = 0.15;
    static final double TURRET_MAX_POWER = 0.7;
    ...
    public void runOpMode() {
        ...
        telemetry.addLine("Auto Ready (Limelight Turret Align)");
        telemetry.update();
    ...
    // ================= TURRET ALIGN (TY ONLY) =================
    private void alignTurretWithLimelight(boolean state) {
    ...
    // ================= SHOOT =================
    private void alignAndShoot(int shootTime, double feed) {

        long start = System.currentTimeMillis();
        while (opModeIsActive() && System.currentTimeMillis() - start < shootTime) {
            alignTurretWithLimelight(true);
    ...
    private void runPath(PathChain path, double speed) {
        ...
        while (opModeIsActive() && follower.isBusy()) {
            follower.update();
            alignTurretWithLimelight(true); // ✅ turret aligns while moving
        }
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            Path1 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(54, 7.075), new Pose(64.972, 17.383)))
                    .setLinearHeadingInterpolation(Math.toRadians(90), Math.toRadians(109))
                    .build();

            Path2 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(64.972, 17.383), new Pose(41.888, 35.654)))
                    .setLinearHeadingInterpolation(Math.toRadians(109), Math.toRadians(180))
                    .build();

            Path3 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(41.888, 35.654), new Pose(18.617, 35.664)))
                    .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                    .build();

            Path4 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(18.617, 35.664), new Pose(64.495, 18.009)))
                    .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(115))
                    .build();

            Path5 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(64.664, 18.112), new Pose(40.748, 60.224)))
                    .setLinearHeadingInterpolation(Math.toRadians(115), Math.toRadians(180))
                    .build();

            Path6 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(40.748, 60.224), new Pose(19.290, 59.888)))
                    .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                    .build();

            Path7 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(19.290, 59.888), new Pose(58, 84.757)))
                    .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(136))
                    .build();

            Path8 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(58, 84.757), new Pose(43, 83)))
                    .setLinearHeadingInterpolation(Math.toRadians(136), Math.toRadians(180))
                    .build();

            Path9 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(43, 83), new Pose(25, 84.308)))
                    .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                    .build();

            Path10 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(25, 84.308), new Pose(58, 84)))
                    .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(136))
                    .build();

            Path11 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(58, 84), new Pose(35.430, 71.738)))
