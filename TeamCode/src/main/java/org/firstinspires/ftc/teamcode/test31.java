...
@Configurable
@TeleOp(name = "test31")
public class test31 extends OpMode {
    ...
    /* ================= LIMELIGHT PD (TY BASED) ================= */

    // CLOSE RANGE
    public static double LL_CLOSE_kP = 0.020;
    public static double LL_CLOSE_kD = 0.004;
    public static int    LL_CLOSE_TARGET_TY = 0;

    // FAR RANGE
    public static double LL_FAR_kP = 0.00035;
    public static double LL_FAR_kD = 0.0003512;
    public static int    LL_FAR_TARGET_TY = 0;

    public static double LL_Y_CLOSE_THRESHOLD = 49;
    public static double LL_DEADBAND = 0.8;
    ...
    private void alignTurretLimelight(LLResult ll) {
        ...
        double kD = close ? LL_CLOSE_kD : LL_FAR_kD;
        int targetTY = close ? LL_CLOSE_TARGET_TY : LL_FAR_TARGET_TY;

        double error = tx - targetTY;
    ...
    private void alignTurretPedro() {
        ...
        double fieldAngle = Math.toDegrees(
                Math.atan2(131 - pose.getY(), 29 - pose.getX())
        );
