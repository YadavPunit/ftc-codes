...
@Configurable
@Autonomous(name = "blue__final_auto_bl", group = "Auto")
public class blue__final_auto_bl extends LinearOpMode {
    ...
    static final double SHOOTER_RPM = 3740;
    static final double HOOD_POS = 0.25;
