...
@Configurable
@TeleOp(name = "test31_ll")
public class test31_ll extends OpMode {
    ...
    /* ================= LIMELIGHT TX PIDF ================= */
    public static double LL_kP = 0.015;
    public static double LL_kI = 0.0;
    public static double LL_kD = 0.002;
    public static double LL_kF = 0.03;

    public static double LL_TARGET_TX = 0.0; // tx at which turret is aligned
    public static double LL_DEADBAND = 0.25;
    ...
    /* ================= LIMELIGHT TURRET PIDF (TX) ================= */
    private void alignTurretLimelightTX(LLResult ll) {

        double tx = ll.getTx();
        double error = tx - LL_TARGET_TX;
        ...
        llIntegral += error;
        llIntegral = clamp(llIntegral, -50, 50);

        double derivative = error - lastLLError;
        lastLLError = error;

        double feedforward = Math.signum(error) * LL_kF;
