...
public class blue_final_auto_PIDF_2 extends LinearOpMode {
    ...
    /* ================= HARDWARE ================= */
    public DcMotorEx shooterL, shooterR, turret;
    public DcMotor intake;
    public Servo hood, leftRamp, rightRamp;
    ...
    private static final double TURRET_kD = 0.2;
    ...
    private void setTurretTargetDegrees(double degrees) {
        turretTargetTicks = clampInt(
                (int) (degrees * TICKS_PER_DEGREE),
                TURRET_MIN_TICKS, TURRET_MAX_TICKS);
        turretIntegral = 0;
        turretLastError = 0;
    }
    ...
    private boolean readyToShoot() {
        return shooterAtSpeed() &&
                Math.abs(turretTargetTicks - turret.getCurrentPosition()) < DEAD_BAND_TICKS;
    }
