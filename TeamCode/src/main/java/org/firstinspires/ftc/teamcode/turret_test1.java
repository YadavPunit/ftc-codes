...
@TeleOp(name = "turret_test1")
public class turret_test1 extends OpMode {
    ...
    // 🔥 FIXED, EXPLICIT DIRECTION
    // Flip this ONE value if needed
    static final double TURRET_DIRECTION = -1.0;
    ...
    public void loop() {
        ...
        if (align && hasTarget) {
            ...
            // ===== TY ERROR (CORRECT & EXPLICIT) =====
            double rawError =
                    TURRET_DIRECTION * (ll.getTy() - TY_ALIGN_OFFSET);
