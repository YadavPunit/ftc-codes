...
@Autonomous(name = "blue_bl1", group = "Auto")
public class blue_bl1 extends LinearOpMode {
    ...
    private void alignAndShoot(double rpm, boolean turretAlign,
                               double tyOffset, double turretKP) {

        if (turretAlign) {
            alignTurretWithLimelight(tyOffset, turretKP);
        }
    ...
    // ================= TURRET ALIGN =================
    private void alignTurretWithLimelight(double tyOffset, double turretKP) {
