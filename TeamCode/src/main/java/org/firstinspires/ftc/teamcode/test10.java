...
@Configurable
@TeleOp(name = "test10")
public class test10 extends OpMode {
    ...
    static final double TY_ALIGN_OFFSET = 1.0;
    static final double ALIGN_DEADBAND = 0.3;
    static final double MAX_ALIGN_ERROR = 1.0;
    ...
    static final double TX_LONG_MIN = 17;
    ...
    private void updateAutoShot(double tx) {
        ...
        if (tx <= TX_SHORT_MAX) {
            targetRPM = lerp(TX_SHORT_MIN, TX_SHORT_MAX, RPM_SHORT_MIN, RPM_SHORT_MAX, tx);
            hoodPos = lerp(TX_SHORT_MIN, TX_SHORT_MAX, HOOD_SHORT_MIN, HOOD_SHORT_MAX, tx);
        } else {
            targetRPM = lerp(TX_LONG_MIN, TX_LONG_MAX, RPM_LONG_MIN, RPM_LONG_MAX, tx);
            hoodPos = lerp(TX_LONG_MIN, TX_LONG_MAX, HOOD_LONG_MIN, HOOD_LONG_MAX, tx);
        }
