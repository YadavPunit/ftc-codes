...
@Autonomous(name = "blue_aliance_path", group = "Auto")
public class blue_aliance_path extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        follower.setStartingPose(
                new Pose(65.7196, 16.8790635, Math.toRadians(90))
        );
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            Path1 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(56.000, 8.000), new Pose(65.395, 16.879))
                    )
            ...
            Path2 = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    new Pose(65.395, 16.879),
                                    new Pose(66.474, 35.872),
                                    new Pose(30.647, 36.087)
                            )
                    )
            ...
            Path3 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(30.647, 36.087), new Pose(65.395, 16.879))
                    )
            ...
            Path4 = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    new Pose(65.395, 16.879),
                                    new Pose(74.891, 63.713),
                                    new Pose(31.942, 60.260)
                            )
                    )
                    .setLinearHeadingInterpolation(Math.toRadians(135), Math.toRadians(180))
                    .build();
            ...
            Path5 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(31.942, 60.260), new Pose(71.222, 72.562))
                    )
                    .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(135))
                    .build();
            ...
            Path6 = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    new Pose(71.222, 72.562),
                                    new Pose(70.791, 89.180),
                                    new Pose(33.237, 84.648)
                            )
                    )
                    .setLinearHeadingInterpolation(Math.toRadians(135), Math.toRadians(180))
                    .build();
            ...
            Path7 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(33.237, 84.648), new Pose(72.301, 72.130))
                    )
                    .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(135))
                    .build();
