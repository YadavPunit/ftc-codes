...
@Autonomous(name = "blue_backleft2", group = "Auto")
public class blue_backleft2 extends LinearOpMode {
    ...
    /* ================= TURRET ================= */
    static final double TURRET_kP = 0.007;
    ...
    private Integer turretTargetTicks = null;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive() && state != AutoState.DONE) {
            ...
            switch (state) {
                ...
                case PATH1:
                    if (!follower.isBusy()) {
                        applyConfig(0.9, 3750, 0.75, 0.25, 0, true);
                        setTurretTargetDegrees(53);
    ...
    private void updateTurret() {
        ...
        if (turretTargetTicks != null) {
            double error = turretTargetTicks - currentPos;
            double derivative = error - lastTurretError;
            power = (TURRET_kP * error) + (TURRET_kD * derivative);
            lastTurretError = error;
        }
        else if (cfgTurretAlign) {
